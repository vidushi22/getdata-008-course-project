...
Version 1.0
==============================================================
by Vidushi Bhandari - course project submission
==============================================================
...
- Consquently the appropriate "activity"'s and "subject"'s are appended to the "test" and the "training" data, which are then combined into one single data frame
...
- Lastly, with the help of the "melt" and "dcast" functions of the "reshape2" package, the data is converted into a table containing mean values of all the included features, ordered by the activity and the subject, and the data is written to the "tidy_movement_data.txt" file.
